...
{
	[AutoloadHead]
    public class Spelunker : ModNPC
    {
     public override string Texture
		{
			get
			{
				return "SaobiesMod/NPCs/Spelunker";
			}
		}
        ...
        {
            button = "Browse Collection";   //this defines the buy button name
        }
        ...
        public override void SetupShop(Chest shop, ref int nextSlot)       //Allows you to add items to this town NPC's shop. Add an item by setting the defaults of shop.item[nextSlot] then incrementing nextSlot.
        {
            ...
            {
                shop.item[nextSlot].SetDefaults(mod.ItemType("SpelunkerRing"));
				nextSlot++;        
            }
			if (NPC.downedBoss2)
			{
        ...
        public override string GetChat()       //Allows you to give this town NPC a chat message when a player talks to it.
        {
         /*   int wizardNPC = NPC.FindFirstNPC(NPCID.Wizard);   //this make so when this npc is close to Wizard
            ...
            {
                case 0:
                    return "Whats wrong with my mask?";
                case 1:
                    return "This one shines brighter than your will to live!";
                case 2:
                    return "These were not easy to get. But for you, premium price.";
                case 3:
                    return "Hope you have some torches for the dark caves.";
				case 4:
                    return "You mine ores with THAT? Yeesh...";
				case 5:
                    return "Heyo! Here to buy something shiny?";
				case 6:
                    return "Best be careful down in those caves.";
                default:
                    return "Stop asking about my mask!";
