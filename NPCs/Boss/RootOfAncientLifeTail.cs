...
{    
    public class RootOfAncientLifeTail : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            npc.height = 52;      //this is where you put the npc sprite height.   important
            npc.damage = 50;
            npc.defense = 70;
            npc.lifeMax = 1;
        ...
        public override bool PreAI()
        {
			...
			if(projectileTimer1++ == 20) // EVERY 60 TICKS EQUALS TO 1 SECOND SO THIS CAUSES BOSS TO SHOOT EVERY 3 SECOND
			{
				...
				float knockBack = 0;
				int type = ProjectileID.JungleSpike; // The type of the projectile you want to shoot.
