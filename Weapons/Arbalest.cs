...
namespace SaobiesMod.Items.Weapons
{
    public class Arbalest : ModItem
    {
		...
		{
			Tooltip.SetDefault("Call down a flurry of spears upon your foes"
					+ "\nConsumes 10 summoner stones.");
		}
        ...
        {        
            ...
            item.noMelee = true;
            item.knockBack = 2;        
            item.value = Item.buyPrice(0, 28, 0, 0);
            item.rare = 3;
            ...
            item.shoot = ProjectileID.DD2BallistraProj;  //this make the item shoot your projectile
		...
		recipe.AddIngredient(mod, "SummonerStone", 10);
		recipe.AddIngredient(ItemID.Book, 25);
		recipe.AddIngredient(ItemID.ManaCrystal, 5);
		recipe.AddIngredient(ItemID.DD2BallistraTowerT1Popper, 1);
