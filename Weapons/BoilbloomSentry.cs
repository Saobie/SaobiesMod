...
{
    public class BoilbloomStaff : ModItem
    {
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Create a flaming bloom sentry that launches exploding fireballs."
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("BoilbloomSentry");   //This defines what type of projectile this weapon will shot	
