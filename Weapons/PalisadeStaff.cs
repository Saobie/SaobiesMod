...
{
    public class PalisadeStaff : ModItem
    {
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Call a defensive tower that strikes foes with lightning."
        ...
        public override void SetDefaults()
        {
            ...
            item.mana = 35;      //this defines how many mana this weapon use
            ...
            item.shoot = mod.ProjectileType("PalisadeTowerSentry");   //This defines what type of projectile this weapon will shot	
