...
{
    public class FirebrambleStaff : ModItem
    {
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("Create a flaming bramble sentry that hurls bouncing fireballs."
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("FirebrambleSentry");   //This defines what type of projectile this weapon will shot	
