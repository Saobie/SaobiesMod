...
{
    public class GargoyleTrident2 : ModProjectile
    {
       ...
       //     projectile.alpha = (int)projectile.localAI[0] * 2;
		...
		public override void Kill(int timeLeft)
        {
			...
			{
				Projectile.NewProjectile (projectile.Center, velocity.RotatedBy(MathHelper.TwoPi / numProj * i) * speed, mod.ProjectileType("MiniTrident"), projectile.damage / 4, 0, Main.myPlayer, 0f, 0f);
			}
		}
