...
{
    public abstract class FeederheadINFO : Minion
    {
        protected float idleAccel = 0.05f;
        protected float spacingMult = 1f;
        protected float viewDist = 50f;       //minion view Distance
        protected float chaseDist = 0f;       //how far the minion can go
        protected float chaseAccel = 7f;
        protected float inertia = 40f;
        protected float shootCool = 30f;       //how fast the minion can shoot
