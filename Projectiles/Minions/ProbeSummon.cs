...
{  
    public class ProbeSummon : FeederheadINFO
    {
        ...
        public override void CheckActive()
        {
            ...
            if (player.dead)
            {
                modPlayer.ProbeSummon = false;
            }
            if (modPlayer.ProbeSummon)
            {
        ...
        {
            Lighting.AddLight((int)(projectile.Center.X / 16f), (int)(projectile.Center.Y / 16f), 1.8f, 0.5f, 0.3f);
