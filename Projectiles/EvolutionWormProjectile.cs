...
{
    public class EvolutionWormProjectile : ModProjectile
    {
        ...
        {
            Texture2D texture = ModLoader.GetTexture("SaobiesMod/Projectiles/EvolutionWormChain");    //this where the chain of grappling hook is drawn
