...
{
    public class CrystalViperProjectile : ModProjectile
    {
        ...
        {
            Texture2D texture = ModLoader.GetTexture("SaobiesMod/Projectiles/CrystalViperChain");    //this where the chain of grappling hook is drawn
