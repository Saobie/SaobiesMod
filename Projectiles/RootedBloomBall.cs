...
{
    public class RootedBloomBall : ModProjectile
    {
		...
		public override void AI()
        {
			...
			Dust dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 3, 0f, 0f, 100, default(Color), 2f);
			dust.noGravity = true;
		}
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
           Player player = Main.player[projectile.owner];
			...
			{
				Projectile.NewProjectile (projectile.Center, velocity.RotatedBy(MathHelper.TwoPi / numProj * i) * speed, ProjectileID.FlowerPetal, damage / 4, 0, Main.myPlayer, 0f, 0f);
			}
        ...
        public override bool PreDraw(Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture = ModLoader.GetTexture("SaobiesMod/Projectiles/RootedBloom_Chain");
