...
{
    public class VortexCrawlerProjectile : ModProjectile
    {
        ...
        {
            speed = 18f;   //this is the grappling hook retire speed
        }
 
        public override void PostDraw(Microsoft.Xna.Framework.Graphics.SpriteBatch spriteBatch, Color lightColor)
        {
            Texture2D texture = ModLoader.GetTexture("SaobiesMod/Projectiles/VortexCrawlerChain");    //this where the chain of grappling hook is drawn
