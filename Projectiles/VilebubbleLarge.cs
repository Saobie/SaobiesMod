...
{
    public class VilebubbleLarge : ModProjectile
    {
		...
		public override void Kill(int timeLeft)
        {
			...
			{
				Projectile.NewProjectile (projectile.Center, velocity.RotatedBy(MathHelper.TwoPi / numProj * i) * speed, mod.ProjectileType("VilebubbleSmall"), projectile.damage / 4, 0, Main.myPlayer, 0f, 0f);
			}
		}
